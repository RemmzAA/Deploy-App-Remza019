...
from viewer_config_api import viewer_config_router
...
# 🔐 SECURITY LEVEL 3 - Add Security Middleware
app.add_middleware(SecurityMiddleware)
logger.info("🔐 Security Level 3 ACTIVATED - All requests protected")
...
app.include_router(viewer_config_router)
